...
void FSM_State_BalanceStand<T>::BalanceStandStep() {
  ...
  if(this->_data->controlParameters->use_rc){
    ...
    // Orientation
    _wbc_data->pBody_RPY_des[0] = rc_cmd->rpy_des[0]*0.2;
    _wbc_data->pBody_RPY_des[1] = rc_cmd->rpy_des[1]*0.36;
    _wbc_data->pBody_RPY_des[2] -= rc_cmd->rpy_des[2]*.4;
