#include "motor_control_demo/motor_interface.h"
...
namespace motor_control_demo
{
    ...
    hardware_interface::CallbackReturn DiffBotSystemHardware::on_deactivate(const rclcpp_lifecycle::State& /*previous_state*/)
    {
        ...
        {
            rclcpp::sleep_for(std::chrono::seconds(1));
            RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"), "%.1f seconds left...", hw_stop_sec_ - i);
        }
        // END: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(motor_control_demo::MotorControlHardware, hardware_interface::SystemInterface)
